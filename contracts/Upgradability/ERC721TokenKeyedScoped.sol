 ...
 */
contract ERC721TokenKeyedScoped is StorageConsumer, ERC721 {
  using SafeMath for uint256;

  string tokenType;

  constructor(BaseStorage storage_, string tokenType_) StorageConsumer(storage_) public {
  ...
  */
  function totalSupply() public view returns (uint256) {
    return _storage.getUint(keccak256("totalTokens", tokenType));
  }
  ...
  */
  function balanceOf(address _owner) public view returns (uint256) {
    return _storage.getUint(keccak256("ownerBalances", tokenType, _owner));
  }
  ...
  */
  function getTokenOwner(uint256 tokenId) private view returns (address) {
    return _storage.getAddress(keccak256("tokenOwners", tokenType, tokenId));
  }
  ...
  */
  function getTokenApproval(uint256 tokenId) private view returns (address) {
    return _storage.getAddress(keccak256("tokenApprovals", tokenType, tokenId));
  }
  ...
  */
  function getOwnedToken(address owner, uint256 tokenIndex) private view returns (uint256) {
    return _storage.getUint(keccak256("ownedTokens", tokenType, owner, tokenIndex));
  }
  ...
  */
  function getOwnedTokenIndex(uint256 tokenId) private view returns (uint256) {
    return _storage.getUint(keccak256("ownedTokensIndex", tokenType, tokenId));
  }
  ...
  */
  function incrementTotalTokens() private {
    _storage.setUint(keccak256("totalTokens", tokenType), totalSupply().add(1));
  }
  ...
  */
  function decrementTotalTokens() private {
    _storage.setUint(keccak256("totalTokens", tokenType), totalSupply().sub(1));
  }
  ...
  */
  function setTokenOwner(uint256 tokenId, address tokenOwner) private {
    _storage.setAddress(keccak256("tokenOwners", tokenType, tokenId), tokenOwner);
  }
  ...
  */
  function setTokenApproval(uint256 tokenId, address approvedAddress) private {
    _storage.setAddress(keccak256("tokenApprovals", tokenType, tokenId), approvedAddress);
  }
  ...
  */
  function incrementOwnerBalance(address owner) private {
    _storage.setUint(keccak256("ownerBalances", tokenType, owner), balanceOf(owner).add(1));
  }
  ...
  */
  function decrementOwnerBalance(address owner) private {
    _storage.setUint(keccak256("ownerBalances", tokenType, owner), balanceOf(owner).sub(1));
  }
  ...
  */
  function setOwnedToken(address owner, uint256 tokenIndex, uint256 tokenId) private {
    _storage.setUint(keccak256("ownedTokens", tokenType, owner, tokenIndex), tokenId);
  }
  ...
  */
  function pushOwnedToken(address owner, uint256 tokenId) private {
    _storage.setUint(keccak256("ownedTokens", tokenType, owner, balanceOf(owner)), tokenId);
  ...
  */
  function setOwnedTokenIndex(uint256 tokenId, uint256 tokenIndex) private {
    _storage.setUint(keccak256("ownedTokensIndex", tokenType, tokenId), tokenIndex);
  }
}
